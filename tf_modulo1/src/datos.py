...
EMPRESAS_CSV = 'empresas.csv'

def cargar_empresas():
    empresas = {}

    if os.path.exists(EMPRESAS_CSV):
        with open(EMPRESAS_CSV, mode="r", encoding="utf-8", newline="") as archivo:
...
def guardar_empresas(empresas):
    with open(EMPRESAS_CSV, mode="w", encoding="utf-8", newline="") as archivo:
